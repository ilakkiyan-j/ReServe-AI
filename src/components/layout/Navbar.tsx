      ...
      <header className="sticky top-0 z-50 glass-panel border-b border-slate-200 dark:border-slate-800 backdrop-blur-md px-6 py-3.5">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-brand-600 to-teal-400 flex items-center justify-center text-white shadow-lg shadow-brand-500/20 font-black text-xl">
              R
            </div>
            <div>
            ...
            {currentUser ? (
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-2 px-3.5 py-1.5 text-xs font-semibold bg-brand-600 hover:bg-brand-700 text-white rounded-lg transition-colors shadow-sm"
                >
                ...
                <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800/80 px-2.5 py-1 rounded-lg border border-slate-200 dark:border-slate-700">
                  <span className="text-[11px] text-slate-400">Role Preview:</span>
                  <select
                    value={currentRole}
                  ...
                  >
                    ...
                    <option value="CAFETERIA_MANAGER" className="dark:bg-slate-900">Cafeteria Manager</option>
                    <option value="EVENT_MANAGER" className="dark:bg-slate-900">Event Manager</option>
                    <option value="RECIPIENT_ORGANIZATION" className="dark:bg-slate-900">Recipient Org</option>
                  </select>
                </div>
              </div>
            )}
